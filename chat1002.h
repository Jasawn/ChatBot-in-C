...
typedef struct response {
    ...
    struct response_ptr* next;
}RESPONSE;


/* ptrWHO, ptrWHAT, ptrWHERE will always point to the first item of the Linked List*/
RESPONSE* ptrWHO, * ptrWHAT, * ptrWHERE;

/* loopWHO, loopWHAT, loopWHERE will be used to traverse the Linked List*/
RESPONSE* loopWHO, * loopWHAT, * loopWHERE;

RESPONSE* getWHO, * getWHAT, * getWHERE;
